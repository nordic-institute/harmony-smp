...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="T10" id="UBL-T10">
  ...
  <param name="BIIPROFILE-T10-R002" value="(//cbc:ProfileID = 'urn:www.cenbii.eu:profile:bii06:ver1.0' and local-name(/*) = 'Invoice' and (//cac:OrderReference/cbc:ID)) or not (//cbc:ProfileID = 'urn:www.cenbii.eu:profile:bii06:ver1.0')" />
