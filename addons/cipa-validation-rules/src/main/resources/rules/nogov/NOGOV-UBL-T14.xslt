...
<xsl:template match="//cac:CreditNoteLine" mode="M5" priority="1003">
    <svrl:fired-rule context="//cac:CreditNoteLine" />
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="((//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'NO') and (cbc:CreditedQuantity/@unitCode != '')) or not ((//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'NO'))" />
      <xsl:otherwise>
        <svrl:failed-assert test="((//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'NO') and (cbc:CreditedQuantity/@unitCode != '')) or not ((//cac:AccountingSupplierParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'NO'))">
