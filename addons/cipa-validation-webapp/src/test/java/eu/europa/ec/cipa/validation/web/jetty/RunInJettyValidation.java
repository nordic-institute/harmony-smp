 ...
 */
package eu.europa.ec.cipa.validation.web.jetty;
...
/**
 * Local validation client runner
 * 
 * @author PEPPOL.AT, BRZ, Philip Helger
 */
public final class RunInJettyValidation {
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettyValidation.class);
  ...
  public static void main (final String... args) throws Exception {
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettyValidation.class.getName ()));
