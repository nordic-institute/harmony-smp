...
import eu.europa.ec.cipa.webgui.app.components.tables.InvoiceLineCommodityClassificationTable;
import eu.europa.ec.cipa.webgui.app.components.tables.InvoiceLineCommodityClassificationTableEditor;
...
public class InvoiceLineCommodityClassificationForm extends Panel {
  ...
  private final List <CommodityClassificationType> lineCommodityList;
  ...
  public InvoiceLineCommodityClassificationForm (final String prefix,
                                                 final List <CommodityClassificationType> lineCommodityList) {
    this.prefix = prefix;
  ...
  private void initElements () {
    ...
    final InvoiceLineCommodityClassificationTableEditor editor = new InvoiceLineCommodityClassificationTableEditor (editMode);
    ...
    final Panel outerPanel = new Panel (prefix + " Commodity Classifications");
