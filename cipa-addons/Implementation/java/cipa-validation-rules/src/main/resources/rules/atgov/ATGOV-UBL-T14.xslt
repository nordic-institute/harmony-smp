...
<!--PATTERN UBL-T14-->
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote" mode="M5" priority="1005">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT') and count(//cac:PayeeFinancialAccount/cbc:ID) = 1) or not ((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT'))" />
      <xsl:otherwise>
        <svrl:failed-assert test="((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT') and count(//cac:PayeeFinancialAccount/cbc:ID) = 1) or not ((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT'))">
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT') and (cac:InvoicePeriod/cbc:StartDate or cac:Delivery/cbc:ActualDeliveryDate)) or not ((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT'))" />
      <xsl:otherwise>
        <svrl:failed-assert test="((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT') and (cac:InvoicePeriod/cbc:StartDate or cac:Delivery/cbc:ActualDeliveryDate)) or not ((//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode = 'AT'))">
          <xsl:attribute name="flag">fatal</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:AccountingSupplierParty/cac:Party" mode="M5" priority="1004">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNoteLine" mode="M5" priority="1003">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentMeans" mode="M5" priority="1001">
...
<xsl:choose>
	...
	<!--RULE -->
<xsl:template match="/ubl:CreditNote/cac:PaymentTerms" mode="M5" priority="1000">
