...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:SelfBilledInvoiceDocumentReference) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:SelfBilledInvoiceDocumentReference) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
...
<xsl:choose>
      ...
      <xsl:otherwise>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:SelfBilledCreditNoteDocumentReference) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:SelfBilledCreditNoteDocumentReference) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:DebitNoteDocumentReference) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:DebitNoteDocumentReference) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:ReminderDocumentReference) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:ReminderDocumentReference) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:AdditionalDocumentReference) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:AdditionalDocumentReference) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:BillingReferenceLine) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:BillingReferenceLine) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:InvoiceDocumentReference/cbc:CopyIndicator) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:InvoiceDocumentReference/cbc:CopyIndicator) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:InvoiceDocumentReference/cbc:XPath) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:InvoiceDocumentReference/cbc:XPath) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:InvoiceDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:InvoiceDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:CreditNoteDocumentReference/cbc:CopyIndicator) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:CreditNoteDocumentReference/cbc:CopyIndicator) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:CreditNoteDocumentReference/cbc:XPath) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:CreditNoteDocumentReference/cbc:XPath) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
		...
		<!--ASSERT -->
<xsl:choose>
      <xsl:when test="(not(cac:BillingReference/cac:CreditNoteDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and $Prerequisite1) or not ($Prerequisite1)" />
      <xsl:otherwise>
        <svrl:failed-assert test="(not(cac:BillingReference/cac:CreditNoteDocumentReference/cac:Attachment/cbc:EmbeddedDocumentBinaryObject) and $Prerequisite1) or not ($Prerequisite1)">
          <xsl:attribute name="flag">warning</xsl:attribute>
          <xsl:attribute name="location">
            <xsl:apply-templates mode="schematron-select-full-path" select="." />
          </xsl:attribute>
