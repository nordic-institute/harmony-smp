...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="T15" id="UBL-T15">
  ...
  <param name="EUGEN-T15-R015" value="((//cac:TaxCategory/cbc:ID) = 'AE' and starts-with(//cac:AccountingCustomerParty/cac:Party/cac:PartyTaxScheme/cbc:CompanyID,//cac:AccountingCustomerParty/cac:Party/cac:PostalAddress/cac:Country/cbc:IdentificationCode)) or not ((//cac:TaxCategory/cbc:ID) = 'AE')" />
  ...
  <param name="EUGEN-T15-R017" value="((//cac:TaxCategory/cbc:ID) = 'AE' and (//cbc:TaxExclusiveAmount = //cac:TaxTotal/cac:TaxSubtotal[cac:TaxCategory/cbc:ID='AE']/cbc:TaxableAmount)) or not ((//cac:TaxCategory/cbc:ID) = 'AE')" />
  <param name="EUGEN-T15-R018" value="((//cac:TaxCategory/cbc:ID) = 'AE' and //cac:TaxTotal/cbc:TaxAmount = 0) or not ((//cac:TaxCategory/cbc:ID) = 'AE')" />
