...
public class ValidatorHandler implements ValidationEventHandler {
  ...
  public ValidatorHandler (final Component c) {
    this.c = c;
    error = true;
  }
  ...
  public boolean handleEvent (final ValidationEvent event) {
    ...
    // System.out.println("    Line Nbr:  " +
    // event.getLocator().getLineNumber());
    // System.out.println("    Column Nbr:  " +
    ...
    if (error) {
      // c.getParent().getWindow().showNotification("Error in document",
      // event.getMessage(),
