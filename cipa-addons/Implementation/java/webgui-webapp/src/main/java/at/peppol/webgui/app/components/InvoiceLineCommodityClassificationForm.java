...
import at.peppol.webgui.app.components.tables.InvoiceLineCommodityClassificationTable;
import at.peppol.webgui.app.components.tables.InvoiceLineCommodityClassificationTableEditor;
...
public class InvoiceLineCommodityClassificationForm extends Panel {
  ...
  public InvoiceLineCommodityClassificationTable table;
  private VerticalLayout hiddenContent;

  
  public InvoiceLineCommodityClassificationForm(String prefix, List<CommodityClassificationType> lineCommodityList) {
      this.prefix = prefix;
      this.lineCommodityList = lineCommodityList;
      editMode = false;
      
      initElements();
  }
  
  public InvoiceLineCommodityClassificationForm(String prefix, List<CommodityClassificationType> lineCommodityList, InvoiceType inv) {
	  this.prefix = prefix;
      this.lineCommodityList = lineCommodityList;
      editMode = false;
      this.inv = inv;
  ...
  private void initElements() {
    ...
    InvoiceLineCommodityClassificationTableEditor editor = new InvoiceLineCommodityClassificationTableEditor(editMode);
    Label label = new Label("<h3>Adding commodity classification line</h3>", Label.CONTENT_XHTML);
    addButton.addListener(editor.addButtonListener(editButton, deleteButton, hiddenContent, table, lineCommodityList, label));
    label = new Label("<h3>Edit commodity classification line</h3>", Label.CONTENT_XHTML);
    editButton.addListener(editor.editButtonListener(addButton, deleteButton, hiddenContent, table, lineCommodityList, label));
