...
import eu.europa.ec.cipa.webgui.app.components.tables.InvoiceItemPropertyTable;
import eu.europa.ec.cipa.webgui.app.components.tables.InvoiceItemPropertyTableEditor;

@SuppressWarnings ("serial")
public class ItemPropertyForm extends Panel {
  private final String itemPropertyPrefix;

  private final List <ItemPropertyType> itemPropertyBeanList;
  ...
  public ItemPropertyForm (final String itemPropertyPrefix, final List <ItemPropertyType> itemPropertyBeanList) {
  ...
  private void initElements () {
    ...
    final InvoiceItemPropertyTableEditor editor = new InvoiceItemPropertyTableEditor (editMode);
    ...
    final Panel outerPanel = new Panel (itemPropertyPrefix + " Item Properties");
    ...
    final Button btn = new Button ("Show/Hide Additional Item Property", new Button.ClickListener () {
      @Override
