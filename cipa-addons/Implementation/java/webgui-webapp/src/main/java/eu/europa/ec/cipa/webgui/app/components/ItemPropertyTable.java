...
public class ItemPropertyTable extends Table {
  ...
  private final BeanItemContainer <InvoiceTaxSubtotalAdapter> tableLines = new BeanItemContainer <InvoiceTaxSubtotalAdapter> (InvoiceTaxSubtotalAdapter.class);
  private final List <String> visibleHeaderNames = new ArrayList <String> ();

  public ItemPropertyTable (final List <ItemPropertyType> list) {
     ...
     * addPropertyWithHeader("TaxSubTotalCategoryPercent",
     * "Tax Category Percent"); setDefinedPropertiesAsVisible();
     * setPageLength(4);
     */
  }
}
