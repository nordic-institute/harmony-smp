...
public class PropertiesUtil {
    ...
    public static final String AP_TRUSTSTORE_PATH = "ap.truststore_path";
    public static final String AP_TRUSTSTORE_PASSWORD = "ap.truststore_password";
    public static final String AP_CA_ALIAS = "ap.ca_alias";
    public static final String AP_ALIAS = "ap.alias";
