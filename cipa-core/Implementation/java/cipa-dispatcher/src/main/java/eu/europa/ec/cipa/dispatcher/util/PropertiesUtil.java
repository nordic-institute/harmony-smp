...
public class PropertiesUtil {
    ...
    public static Properties getProperties(ServletContext context) {
        if (properties == null) {
            try {
                s_aLogger.debug("Loading properties from dispatcher.properties...");
                ...
                if (properties == null) {
                    s_aLogger.error("No configuration file found");
                }
            } catch (Exception e) {
                properties = null;
            }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    s_aLogger.debug("Couldn't load properties: " + configFile);
                }
            }
        }

        if (result != null) {
            s_aLogger.debug("Properties loaded from " + configFile);
        }
