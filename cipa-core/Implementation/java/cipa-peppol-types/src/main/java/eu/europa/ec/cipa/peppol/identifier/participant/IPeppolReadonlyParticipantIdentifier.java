...
import eu.europa.ec.cipa.peppol.identifier.IPeppolReadonlyIdentifier;
...
public interface IPeppolReadonlyParticipantIdentifier extends IPeppolReadonlyIdentifier, IReadonlyParticipantIdentifier {
   ...
   *         {@link eu.europa.ec.cipa.peppol.identifier.validator.IParticipantIdentifierValidatorSPI}
   *         implementations.
   */
  boolean isValid ();
