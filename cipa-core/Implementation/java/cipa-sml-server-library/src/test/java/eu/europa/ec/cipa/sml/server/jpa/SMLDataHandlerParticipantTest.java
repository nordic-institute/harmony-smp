...
public final class SMLDataHandlerParticipantTest {
	...
	public void initTest() throws Throwable {
		...
		m_aParticipantIdentifierPage.getParticipantIdentifier().add(SimpleParticipantIdentifier.createWithDefaultScheme(PARTICIPANT_IDENTIFIER_DEFAULT));
	}
	...
	public void testCreateParticipantIdentifier() throws Throwable {
		...
		final ParticipantIdentifierPageType result = s_aParticipantHandler.listParticipantIdentifiers(request, CLIENT_UNIQUE_ID);
	...
	public void testDeleteParticipantIdentifier() throws Throwable {
		...
		s_aParticipantHandler.deleteParticipantIdentifiers(m_aParticipantIdentifierPage.getParticipantIdentifier(), CLIENT_UNIQUE_ID);
	...
	public void testDeleteParticipantIdentifierNotExistID() throws Throwable {
		try {
			...
			m_aParticipantIdentifierPage.setServiceMetadataPublisherID(SMP_ID2);
			s_aParticipantHandler.deleteParticipantIdentifiers(m_aParticipantIdentifierPage.getParticipantIdentifier(), CLIENT_UNIQUE_ID2);
			fail();
		} catch (final UnauthorizedException ex) {
		}
	}
	...
	public void testMigration() throws Throwable {
		...
		final ParticipantIdentifierPageType resultID2 = s_aParticipantHandler.listParticipantIdentifiers(request, CLIENT_UNIQUE_ID2);
		...
		request.setServiceMetadataPublisherID(SMP_ID);
		final ParticipantIdentifierPageType resultID1 = s_aParticipantHandler.listParticipantIdentifiers(request, CLIENT_UNIQUE_ID);
	...
	public void testMigrationWrongKey() throws Throwable {
		...
		try {
			...
			final PageRequestType request = s_aObjFactory.createPageRequestType();
			request.setServiceMetadataPublisherID(SMP_ID);
			final ParticipantIdentifierPageType resultID2 = s_aParticipantHandler.listParticipantIdentifiers(request, CLIENT_UNIQUE_ID);
			...
			request.setServiceMetadataPublisherID(SMP_ID2);
			final ParticipantIdentifierPageType resultID1 = s_aParticipantHandler.listParticipantIdentifiers(request, CLIENT_UNIQUE_ID2);
