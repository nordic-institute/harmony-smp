 ...
 * To stop the running Jetty simply invoke the {@link JettyStopSMPFull} application
 * in this package. It performs a graceful shutdown of the App Server.
 * 
 * @author PEPPOL.AT, BRZ, Philip Helger
 */
public final class RunInJettySMPFull {
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettySMPFull.class);
  ...
  public static void main (final String... args) throws Exception {
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettySMPFull.class.getName ()));
