 ...
 */
public final class RunInJettySMPReadonly {
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettySMPReadonly.class);
  ...
  public static void main (final String... args) throws Exception {
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettySMPReadonly.class.getName ()));
