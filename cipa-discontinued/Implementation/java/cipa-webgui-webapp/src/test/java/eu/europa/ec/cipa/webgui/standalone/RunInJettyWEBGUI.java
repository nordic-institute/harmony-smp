 ...
 */
package eu.europa.ec.cipa.webgui.standalone;
 ...
 * To stop the running Jetty simply invoke the {@link JettyStopWEBGUI}
 * application in this package. It performs a graceful shutdown of the App
 * Server.
 * 
 * @author PEPPOL.AT, BRZ, Philip Helger
 */
public final class RunInJettyWEBGUI {
  private static final Logger s_aLogger = LoggerFactory.getLogger (RunInJettyWEBGUI.class);
  ...
  public static void main (final String... args) throws Exception {
    ...
    aWebAppCtx.setTempDirectory (new File (SystemProperties.getTmpDir () + '/' + RunInJettyWEBGUI.class.getName ()));
