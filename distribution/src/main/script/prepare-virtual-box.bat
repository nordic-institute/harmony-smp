...
mysql --host=192.168.10.11 --port=3306 --user=root --password=adminuser < mysql.tmp
del mysql.tmp
mysql --host=192.168.10.11 --port=3306 --user=edelivery --password=edelivery edelivery < target/sql-scripts/create-mysql.sql

rem sending the artifact to the virtual box
pscp -P 22 -pw adminuser target/cipa-edelivery-distribution-*.zip adminuser@192.168.10.11:
