...
/**
 * CreatePartnershipResponse.java
 * <p/>
...
/**
 *  CreatePartnershipResponse bean class
 */
@SuppressWarnings({"unchecked", "unused"})

public class CreatePartnershipResponse
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            String namespacePrefix = registerPrefix(xmlWriter, "http://org.ecodex.backend/1_1/");
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":createPartnershipResponse",
                        xmlWriter);
            } else {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "createPartnershipResponse",
    ...
    public static class Factory {
         ...
         */
        public static CreatePartnershipResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception {
            CreatePartnershipResponse object =
                    new CreatePartnershipResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"createPartnershipResponse".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                            return (CreatePartnershipResponse) ExtensionMapper.getTypeObject(
                                    nsUri, type, reader);
                        }
