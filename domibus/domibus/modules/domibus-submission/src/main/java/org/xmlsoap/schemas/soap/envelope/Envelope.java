    ...
    */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (this.localHeaderTracker) {
            ...
            this.localHeader
                    .serialize(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/envelope/", "Header"),
                               xmlWriter);
        }
        if (this.localBodyTracker) {
            ...
            this.localBody.serialize(new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/envelope/", "Body"),
                                     xmlWriter);
        }
