...
public class SendRequest implements org.apache.axis2.databinding.ADBBean {
    ...
    public static final javax.xml.namespace.QName MY_QNAME =
            new javax.xml.namespace.QName("http://org.ecodex.backend/1_1/", "sendRequest", "ns2");
    ...
    public void addPayload(final backend.ecodex.org._1_1.PayloadType param) {
        if (localPayload == null) {
            localPayload = new backend.ecodex.org._1_1.PayloadType[]{};
        }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":sendRequest", xmlWriter);
            } else {
    ...
    public static class Factory {
         ...
         */
        public static SendRequest parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final SendRequest object = new SendRequest();
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("", "payload").equals(reader.getName())) {
                    ...
                    object.setPayload(
                            (backend.ecodex.org._1_1.PayloadType[]) org.apache.axis2.databinding.utils.ConverterUtil
                                                                                                      .convertToArray(
                                                                                                              backend.ecodex.org._1_1.PayloadType.class,
                                                                                                              list2));
