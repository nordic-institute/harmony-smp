   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public void addSignalMessage(final org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.SignalMessage param) {
        ...
        final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localSignalMessage);
        list.add(param);
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public void addUserMessage(final org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.UserMessage param) {
        ...
        final java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localUserMessage);
        list.add(param);
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
    ...
    public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter,
        ...
        if (localMustUnderstandS11 != null) {
            writeAttribute("http://schemas.xmlsoap.org/soap/envelope/", "mustUnderstandS11",
                           localMustUnderstandS11.toString(), xmlWriter);
        }


        writeAttribute("http://www.w3.org/2003/05/soap-envelope", "mustUnderstand",
                       org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localMustUnderstand),
                       xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        attribList.add(localMustUnderstandS11.toString());
    ...
    public static class Factory {
         ...
         */
        public static Messaging parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ...
            try {
                ...
                // handle attribute "id"
                final java.lang.String tempAttribId =

                        reader.getAttributeValue(null, "id");

                if (tempAttribId != null) {
                    final java.lang.String content = tempAttribId;
                ...
                final java.lang.String tempAttribMustUnderstand =

                        reader.getAttributeValue("http://www.w3.org/2003/05/soap-envelope", "mustUnderstand");

                if (tempAttribMustUnderstand != null) {
                    final java.lang.String content = tempAttribMustUnderstand;

                    object.setMustUnderstand(org.apache.axis2.databinding.utils.ConverterUtil.convertToBoolean(
                            tempAttribMustUnderstand));
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setSignalMessage(
                            (org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.SignalMessage[]) org.apache.axis2
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setUserMessage(
                            (org.oasis_open.docs.ebxml_msg.ebms.v3_0.ns.core._200704.UserMessage[]) org.apache.axis2
                                    .databinding.utils.ConverterUtil.convertToArray(
