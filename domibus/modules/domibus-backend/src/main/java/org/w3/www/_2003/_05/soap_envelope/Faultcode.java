...
public class Faultcode implements org.apache.axis2.databinding.ADBBean {
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
     ...
     * @param param Value
     */
    public void setValue(final org.w3.www._2003._05.soap_envelope.FaultcodeEnum param) {
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":faultcode", xmlWriter);
            } else {
    ...
    public static class Factory {
         ...
         */
        public static Faultcode parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            final Faultcode object = new Faultcode();
