...
public class NotUnderstoodType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":NotUnderstoodType", xmlWriter);
            } else {
    ...
    public static class Factory {
         ...
         */
        public static NotUnderstoodType parse(final javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
            final NotUnderstoodType object = new NotUnderstoodType();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"NotUnderstoodType".equals(type)) {
                            ...
                            return (NotUnderstoodType) backend.ecodex.org.ExtensionMapper
                ...
                final java.lang.String tempAttribQname =

                        reader.getAttributeValue(null, "qname");

                if (tempAttribQname != null) {
                    final java.lang.String content = tempAttribQname;
