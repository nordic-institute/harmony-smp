...
public class DownloadMessageRequest implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME =
            new javax.xml.namespace.QName("http://org.ecodex.backend/1_1/", "downloadMessageRequest", "ns1");
    /**
     * field for MessageID
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":downloadMessageRequest", xmlWriter);
            } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName)
        ...
        if (this.localMessageIDTracker) {
            ...
            if (this.localMessageID != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(this.localMessageID));
            } else {
                throw new org.apache.axis2.databinding.ADBException("messageID cannot be null!!");
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DownloadMessageRequest parse(final javax.xml.stream.XMLStreamReader reader) throws Exception {
            final DownloadMessageRequest object = new DownloadMessageRequest();
            int event;
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"downloadMessageRequest".equals(type)) {
                            ...
                            return (DownloadMessageRequest) backend.ecodex.org.ExtensionMapper
