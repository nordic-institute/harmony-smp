...
public class PayloadType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
        ...
        public static PayloadType fromString(final String value, final String namespaceURI) {
         ...
         */
        public static PayloadType parse(final javax.xml.stream.XMLStreamReader reader) throws Exception {
