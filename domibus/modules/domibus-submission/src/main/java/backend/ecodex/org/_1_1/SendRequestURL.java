...
public class SendRequestURL implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addPayload(final backend.ecodex.org._1_1.PayloadURLType param) {
        if (this.localPayload == null) {
            this.localPayload = new backend.ecodex.org._1_1.PayloadURLType[]{};
        }
    ...
    public static class Factory {
         ...
         */
        public static SendRequestURL parse(final javax.xml.stream.XMLStreamReader reader) throws Exception {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName("", "payload").equals(reader.getName())) {
                    ...
                    object.setPayload(
                            (backend.ecodex.org._1_1.PayloadURLType[]) org.apache.axis2.databinding.utils.ConverterUtil
                                    .convertToArray(backend.ecodex.org._1_1.PayloadURLType.class, list2));
