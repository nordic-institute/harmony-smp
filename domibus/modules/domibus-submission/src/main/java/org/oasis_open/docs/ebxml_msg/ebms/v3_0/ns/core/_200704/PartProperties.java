...
public class PartProperties implements org.apache.axis2.databinding.ADBBean {
   ...
   *   for this attribute. It will be used to determine whether to include this field
    ...
    */
     ...
     */
    protected void validateProperty(final Property[] param) {
     ...
     */
    public void setProperty(final Property[] param) {
     ...
     */
    public void addProperty(final Property param) {
        if (this.localProperty == null) {
            this.localProperty = new Property[]{};
        }
            ...
            if (this.localProperty != null) {
                for (int i = 0; i < this.localProperty.length; i++) {
                    if (this.localProperty[i] != null) {
                        this.localProperty[i].serialize(new javax.xml.namespace.QName(
                ...
                for (int i = 0; i < this.localProperty.length; i++) {
                    ...
                    if (this.localProperty[i] != null) {
                        elementList.add(new javax.xml.namespace.QName(
                                "http://docs.oasis-open.org/ebxml-msg/ebms/v3.0/ns/core/200704/", "Property"));
                        elementList.add(this.localProperty[i]);
                    } else {
    ...
    public static class Factory {
         ...
         */
        public static PartProperties parse(final javax.xml.stream.XMLStreamReader reader) throws Exception {
