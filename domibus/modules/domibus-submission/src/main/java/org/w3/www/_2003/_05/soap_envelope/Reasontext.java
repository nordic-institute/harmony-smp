...
public class Reasontext implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
                               namespacePrefix + ":reasontext", xmlWriter);
            } else {
    ...
    public static class Factory {
        ...
        public static Reasontext fromString(final String value, final String namespaceURI) {
            final Reasontext returnValue = new Reasontext();
        ...
        public static Reasontext fromString(final javax.xml.stream.XMLStreamReader xmlStreamReader,
         ...
         */
        public static Reasontext parse(final javax.xml.stream.XMLStreamReader reader) throws Exception {
            final Reasontext object = new Reasontext();
