 ...
 */
@Entity
@Table(indexes = @Index(columnList = "MSH_ROLE"), name = "TB_MESSAGE_LOG")
@NamedQueries({
        ...
        @NamedQuery(name = "MessageLogEntry.findUnsentMessages", query = "select mle.messageId from MessageLogEntry mle where mle.messageStatus = eu.domibus.common.MessageStatus.IN_PROGRESS and mle.nextAttempt < CURRENT_TIMESTAMP and mle.sendAttempts <= mle.sendAttemptsMax"),
