...
(3, 1, 1, 'pat_system', '$2a$06$FDmjewn/do3C219uysNm9.XG8mIn.ubHnMydAzC8lsv61HsRpOR36', 'ACCESS_TOKEN', 'REST_API', sysdate-3,  sysdate+3, sysdate,  sysdate);
...
insert into SMP_CREDENTIAL (ID, FK_USER_ID, CREDENTIAL_ACTIVE, CREDENTIAL_NAME, CREDENTIAL_VALUE, CREDENTIAL_TYPE, CREDENTIAL_TARGET, ACTIVE_FROM, EXPIRE_ON,CREATED_ON, LAST_UPDATED_ON) values
(5, 2, 1, 'user', '$2a$06$FDmjewn/do3C219uysNm9.XG8mIn.ubHnMydAzC8lsv61HsRpOR36', 'ACCESS_TOKEN', 'REST_API', sysdate-3,  sysdate+3, sysdate,  sysdate);
insert into SMP_CREDENTIAL (ID, FK_USER_ID, CREDENTIAL_ACTIVE, CREDENTIAL_NAME, CREDENTIAL_VALUE, CREDENTIAL_TYPE, CREDENTIAL_TARGET,ACTIVE_FROM, EXPIRE_ON, CREATED_ON, LAST_UPDATED_ON) values
(6, 2, 1, 'LvglqPCs', '$2a$10$zaFAFqFIfLUZx15ZDPMvDeWBtsZLaAkrY3Vmya5e3/yCCkFq/FJCu', 'ACCESS_TOKEN', 'REST_API', sysdate-3,  sysdate+3, sysdate,  sysdate) ;
...
insert into SMP_CREDENTIAL (ID, FK_USER_ID, CREDENTIAL_ACTIVE, CREDENTIAL_NAME, CREDENTIAL_VALUE, CREDENTIAL_TYPE, CREDENTIAL_TARGET, CREATED_ON, LAST_UPDATED_ON) values
(14, 2, 1, N'CN=EHEALTH_z_ẞ_W_,O=European_z_ẞ_W_Commission,C=BE:f71ee8b11cb3b787', null, 'CERTIFICATE', 'REST_API',  sysdate,  sysdate);
insert into SMP_CREDENTIAL (ID, FK_USER_ID, CREDENTIAL_ACTIVE, CREDENTIAL_NAME, CREDENTIAL_VALUE, CREDENTIAL_TYPE, CREDENTIAL_TARGET, CREATED_ON, LAST_UPDATED_ON) values
(15, 4, 1, 'CN=EHEALTH_SMP4_EC,O=European Commission,C=BE:f71ee8b11cb3b878', null, 'CERTIFICATE', 'REST_API',  sysdate,  sysdate);
insert into SMP_CREDENTIAL (ID, FK_USER_ID, CREDENTIAL_ACTIVE, CREDENTIAL_NAME, CREDENTIAL_VALUE, CREDENTIAL_TYPE, CREDENTIAL_TARGET, CREATED_ON, LAST_UPDATED_ON) values
(16, 3, 1, 'CN=EHEALTH_SMP3_EC,O=European Commission,C=BE:f71ee8b11cb3b979', null, 'CERTIFICATE', 'REST_API',  sysdate,  sysdate);
...
insert into SMP_CERTIFICATE (ID, CERTIFICATE_ID, SUBJECT, ISSUER, SERIALNUMBER,VALID_FROM, VALID_TO, CREATED_ON, LAST_UPDATED_ON) values
(14, N'CN=EHEALTH_z_ẞ_W_,O=European_z_ẞ_W_Commission,C=BE:f71ee8b11cb3b787',N'CN=EHEALTH_z_ẞ_W_,O=European_z_ẞ_W_Commission,C=BE',N'CN=EHEALTH_z_ẞ_W_,O=European_z_ẞ_W_Commission,C=BE','f71ee8b11cb3b787', sysdate - 365, sysdate + 365, sysdate, sysdate);
insert into SMP_CERTIFICATE (ID, CERTIFICATE_ID, SUBJECT, ISSUER, SERIALNUMBER,VALID_FROM, VALID_TO, CREATED_ON, LAST_UPDATED_ON) values
(15, 'CN=EHEALTH_SMP4_EC,O=European Commission,C=BE:f71ee8b11cb3b878','CN=EHEALTH_SMP4_EC,O=European Commission,C=BE','CN=EHEALTH_SMP4_EC,O=European Commission,`C=BE','f71ee8b11cb3b878', sysdate - 365, sysdate + 365, sysdate, sysdate);
insert into SMP_CERTIFICATE (ID, CERTIFICATE_ID, SUBJECT, ISSUER, SERIALNUMBER,VALID_FROM, VALID_TO, CREATED_ON, LAST_UPDATED_ON) values
(16, 'CN=EHEALTH_SMP3_EC,O=European Commission,C=BE:f71ee8b11cb3b979','CN=EHEALTH_SMP3_EC,O=European Commission,C=BE','CN=EHEALTH_SMP3_EC,O=European Commission,`C=BE','f71ee8b11cb3b979', sysdate - 365, sysdate + 365, sysdate, sysdate);
