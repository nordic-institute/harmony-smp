...
class PeppolSMPSubresourceTest {

    PeppolSMPSubresourceHandler mockOasisSMPSubresource10Handler = Mockito.mock(PeppolSMPSubresourceHandler.class);
    PeppolSMPSubresource testInstance = new PeppolSMPSubresource(mockOasisSMPSubresource10Handler);

    @Test
    void identifier() {
        String result = testInstance.identifier();

        assertEquals("peppol-smp-servicemetadata", result);
    }
    ...
    void description() {
        ...
        assertEquals("Peppol SMP Service Metadata resource handler", result);
    }
    ...
    void testToString() {
        ...
        MatcherAssert.assertThat(result, CoreMatchers.containsString("peppol-smp-servicemetadata"));
    }
}
