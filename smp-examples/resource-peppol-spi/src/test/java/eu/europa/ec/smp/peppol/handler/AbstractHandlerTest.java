...
abstract class AbstractHandlerTest {
    ...
    void readResourceAction(String resourceName, ResourceIdentifier resourceIdentifier) throws ResourceException {
        readResourceAction(null, resourceName, resourceIdentifier);
    }

    void readResourceAction(String serviceUrlSegment, String resourceName, ResourceIdentifier resourceIdentifier) throws ResourceException {
        readResourceAction(serviceUrlSegment, resourceName, resourceIdentifier, null);
    }
    ...
    void readResourceAction(String resourceName, ResourceIdentifier resourceIdentifier, ResourceIdentifier subresourceIdentifier) throws ResourceException {
        readResourceAction(null, resourceName, resourceIdentifier, subresourceIdentifier);
    }
    void readResourceAction(String serviceUrlSegment, String resourceName, ResourceIdentifier resourceIdentifier, ResourceIdentifier subresourceIdentifier) throws ResourceException {

        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        Mockito.doReturn(TEST_DOMAIN_CODE).when(requestData).getDomainCode();
        Mockito.doReturn(serviceUrlSegment).when(requestData).getDomainCode();
        Mockito.doReturn(baos).when(responseData).getOutputStream();
        Mockito.doReturn(PeppolSMPResource.class.getResourceAsStream(resourceName)).when(requestData).getResourceInputStream();
        ...
        documentAttributes.put(TransientDocumentPropertyType.RESOURCE_URL_SEGMENT.getPropertyName(), serviceUrlSegment);
        documentAttributes.put(TransientDocumentPropertyType.RESOURCE_IDENTIFIER_VALUE.getPropertyName(), resourceIdentifier.getValue());
        documentAttributes.put(TransientDocumentPropertyType.RESOURCE_IDENTIFIER_SCHEME.getPropertyName(), resourceIdentifier.getScheme());


        Mockito.doReturn(documentAttributes).when(requestData).getDocumentAttributes();
    ...
    abstract AbstractPeppolSMPHandler getTestInstance();
}
