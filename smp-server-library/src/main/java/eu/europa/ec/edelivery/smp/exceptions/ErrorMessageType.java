...
public enum ErrorMessageType {
    ...
    CONFIGURATION_INVALID_PROPERTY(CONFIGURATION_ERROR,"error.configuration.property", "Configuration property [{{propertyName}}] has error: [{{error}}]!", ERROR),
    ...
    CONFIGURATION_INVALID_CRON_EXPRESSION(CONFIGURATION_ERROR,"error.configuration.invalid.cron.expression", "Configuration error: cron expression [{{propertyValue}}]! Error: [{{error}}]!", PROPERTY_VALUE, ERROR),
    ...
    INVALID_PROPERTY_BOOLEAN(PROPERTY_VALIDATION_ERROR, "error.invalid.property.boolean", "Property [{{property}}] is not valid Boolean type!", PROPERTY),
    INVALID_PROPERTY_CRON_EXPRESSION(PROPERTY_VALIDATION_ERROR, "error.invalid.property.cron.expression", "Property [{{property}}] is not valid Cron Expression type!", PROPERTY),
    INVALID_PROPERTY_DATETIME(PROPERTY_VALIDATION_ERROR, "error.invalid.property.datetime", "Property value [{{property}}] must be less than 2000 characters!", PROPERTY),
    INVALID_PROPERTY_EMAIL(PROPERTY_VALIDATION_ERROR, "error.invalid.property.email", "Property [{{property}}] is not valid Email address type!", PROPERTY),
    INVALID_PROPERTY_FILENAME(PROPERTY_VALIDATION_ERROR, "error.invalid.property.filename", "Property [{{property}}] is not valid Filename type or it does not exists!", PROPERTY),
    INVALID_PROPERTY_INTEGER(PROPERTY_VALIDATION_ERROR, "error.invalid.property.integer", "Property [{{property}}] is not valid Integer!", PROPERTY),
    INVALID_PROPERTY_LIST_STRING(PROPERTY_VALIDATION_ERROR, "error.invalid.property.list.string", "Property [{{property}}] is not valid LIST_STRING type!", PROPERTY),
    INVALID_PROPERTY_MAP_STRING(PROPERTY_VALIDATION_ERROR, "error.invalid.property.map.string", "Property [{{property}}] is not valid MAP_STRING type!", PROPERTY),
    INVALID_PROPERTY_MISSING(CONFIGURATION_ERROR, "error.invalid.property.missing", "Property [{{property}}] is mandatory and must not be NULL OR empty!", PROPERTY),
    INVALID_PROPERTY_PATH(PROPERTY_VALIDATION_ERROR, "error.invalid.property.path", "Property [{{property}}] is not valid Path type or it does not exists!", PROPERTY),
    INVALID_PROPERTY_REGEXP(PROPERTY_VALIDATION_ERROR, "error.invalid.property.regexp", "Property [{{property}}] is not valid Regular Expression type!", PROPERTY),
    INVALID_PROPERTY_STRING(PROPERTY_VALIDATION_ERROR, "error.invalid.property.string", "Property value [{{property}}] must be less than 2000 characters!", PROPERTY),
    INVALID_PROPERTY_UNKNOWN(CONFIGURATION_ERROR,"error.invalid.property.unknown", "Property [{{property}}] is not SMP property!", PROPERTY),
    INVALID_PROPERTY_URL(PROPERTY_VALIDATION_ERROR, "error.invalid.property.url", "Property [{{property}}] is not valid URL!", PROPERTY),
    ...
    INVALID_REQUEST_DOCUMENT_GENERATION_VALIDATION(INVALID_REQUEST, "error.invalid.request.document.generation.validation", "Invalid request [GenerateDocument]. Error: [{{error}}]!", ERROR),
    ...
    INVALID_REQUEST_DOCUMENT_VALIDATION_DOCUMENT_VERSION_NOT_FOUND_TAG(INVALID_REQUEST, "error.invalid.request.document.validation.document.version.not.found.tag", "Invalid request [DocumentVersionNotFound]. Error: document version not found!"),
