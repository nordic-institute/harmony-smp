...
public enum ErrorMessageType implements IErrorCodeType {
    ...
    CONFIGURATION_PROPERTY(CONFIGURATION_ERROR, "error.configuration.property", "Configuration property [{{propertyName}}] has error: [{{error}}]!", ERROR),
    ...
    INVALID_REQUEST_RESOURCE_CREATE_IDENTIFIER_VALUE_INVALID_CHARACTERS(INVALID_REQUEST, "error.invalid.request.resource.create.identifier.value.invalid.characters", "Invalid request [CreateResourceForGroup]. Error: resource identifier contains characters that are not allowed [{{identifier}}].", IDENTIFIER),
