...
public enum ErrorMessageType implements IErrorCodeType {
    ...
    INVALID_PROPERTY_INTEGER(PROPERTY_VALIDATION_ERROR, "error.invalid.property.integer", "Property value: [{{propertyValue}}] is not valid Integer!", ErrorMessageArgument.PROPERTY_NAME),
