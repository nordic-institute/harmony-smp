...
DELETE FROM SMP_DOMAIN_DOC_TMPL;
DELETE FROM SMP_DOMAIN_DOC_TMPL_AUD;
DELETE FROM SMP_DOCUMENT_VERSION_EVENT;
DELETE FROM SMP_DOCUMENT_CERTIFICATE;
DELETE FROM SMP_DOCUMENT_CERTIFICATE_AUD;
...
DELETE FROM SMP_PERIODICAL_ALERT;
DELETE FROM SMP_PERIODICAL_ALERT_AUD;
