...
/*
        ...
        Identifier documentIdentifier = identifierService.normalizeDocumentIdentifier(serviceMetadataId);
        ...
        try {
            ...
            throw new SMPRuntimeException(ErrorCode.INTERNAL_ERROR, e, "Error occurred while signing service metadata", e.getMessage());
        }
 ...
 */
    ...
    //        " OR @resourceGuard.isResourceAdmin(authentication.name, #serviceGroupId)")
