...
public class ResourceConstants {
    ...
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_UPDATE = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_ACTION_UPDATE;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_PUBLISH = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_ACTION_PUBLISH;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_GET = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_DOCUMENT;
    // ------------------------------------------
    // group management
