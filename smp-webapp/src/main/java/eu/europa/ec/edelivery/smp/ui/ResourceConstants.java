...
public class ResourceConstants {
    ...
    public static final String PATH_RESOURCE_TYPE_TEMPLATE = "template";
    ...
    public static final String PATH_RESOURCE_TYPE_VERSION = "version";
    ...
    public static final String PATH_PARAM_ENC_TEMPLATE_ID = "template-id";
    ...
    public static final String CONTEXT_PATH_EDIT = "/ui/edit/rest/";
    public static final String CONTEXT_PATH_EDIT_USERID = CONTEXT_PATH_EDIT + "{" + PATH_PARAM_ENC_USER_ID + "}";
    // edit domain data paths
    public static final String CONTEXT_PATH_EDIT_DOMAIN = CONTEXT_PATH_EDIT_USERID + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_DOMAIN;
    ...
    // ------------------------------------------
    // Domain document template management
    public static final String CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE = CONTEXT_PATH_EDIT_DOMAIN + URL_PATH_SEPARATOR + SUB_CONTEXT_PATH_EDIT_DOMAIN_ADMIN
            + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_TEMPLATE;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_CREATE = PATH_ACTION_CREATE;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_DELETE = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_ACTION_DELETE;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_VALIDATE = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR +  PATH_ACTION_VALIDATE;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_GENERATE = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR +  PATH_ACTION_GENERATE;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_VERSION_UPDATE = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_VERSION + URL_PATH_SEPARATOR + PATH_ACTION_UPDATE;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_VERSION_PUBLISH = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_VERSION + URL_PATH_SEPARATOR+ PATH_ACTION_PUBLISH;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_VERSION_GET = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_VERSION + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_DOCUMENT;
    public static final String SUB_CONTEXT_PATH_EDIT_DOMAIN_DOC_TEMPLATE_VERSION_DELETE = "{" + PATH_PARAM_ENC_TEMPLATE_ID + "}"
            + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_VERSION + URL_PATH_SEPARATOR + PATH_ACTION_DELETE;
    // ------------------------------------------
    // group management
    ...
    public static final String CONTEXT_PATH_EDIT_RESOURCE_SHORT = CONTEXT_PATH_EDIT_USERID + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_RESOURCE +
    ...
    public static final String CONTEXT_PATH_EDIT_DOCUMENT_RESOURCE = CONTEXT_PATH_EDIT_USERID + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_RESOURCE + URL_PATH_SEPARATOR + "{" + PATH_PARAM_ENC_RESOURCE_ID + "}";
    ...
    public static final String SUB_CONTEXT_PATH_EDIT_DOCUMENT_RESOURCE_DELETE = SUB_CONTEXT_PATH_EDIT_DOCUMENT_RESOURCE + URL_PATH_SEPARATOR + PATH_ACTION_DELETE;
    ...
    public static final String SUB_CONTEXT_PATH_EDIT_DOCUMENT_SUBRESOURCE_DELETE = SUB_CONTEXT_PATH_EDIT_DOCUMENT_SUBRESOURCE + URL_PATH_SEPARATOR + PATH_ACTION_DELETE;
    ...
    public static final String CONTEXT_PATH_EDIT_REVIEW = CONTEXT_PATH_EDIT_USERID + URL_PATH_SEPARATOR + PATH_RESOURCE_TYPE_REVIEW;
    // public
