...
-- ------------------------------------------------------------------------
    ...
    create table SMP_USER (
       ID bigint not null auto_increment comment 'Unique user id',
        ...
        SMP_THEME varchar(64)  CHARACTER SET utf8 COLLATE utf8_bin comment 'DomiSMP theme for the user',
...
create index SMP_SMD_DOC_SCH_IDX on SMP_SUBRESOURCE (IDENTIFIER_SCHEME);
    ...
    alter table SMP_SUBRESOURCE 
       add constraint SMP_SRS_UNIQ_IDENT_RES_SRTYPE_IDX unique (FK_RESOURCE_ID, IDENTIFIER_VALUE, IDENTIFIER_SCHEME);

    alter table SMP_SUBRESOURCE_DEF 
       add constraint SMP_SRES_UNIQ_REDEFID_URLCTX_IDX unique (FK_RESOURCE_DEF_ID, URL_SEGMENT);
