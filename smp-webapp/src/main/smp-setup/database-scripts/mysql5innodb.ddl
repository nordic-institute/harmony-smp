...
-- This file was generated using hibernate version [6.6.27.Final] with dialect [org.hibernate.dialect.MySQL5InnoDBDialect].
-- For more information, refer to the Hibernate dialect documentation.
    ...
    create table SMP_ALERT (
        ...
        ALERT_TYPE enum ('CREDENTIAL_CHANGED','CREDENTIAL_EXPIRED','CREDENTIAL_IMMINENT_EXPIRATION','CREDENTIAL_REQUEST_RESET','CREDENTIAL_SUSPENDED','CREDENTIAL_VERIFICATION_FAILED','SYSTEM_CERTIFICATE_EXPIRED','SYSTEM_CERTIFICATE_IMMINENT_EXPIRATION','TEST_ALERT','USER_CREATED','USER_CREATED_CONFIRMATION','USER_CREATED_EU_LOGIN','USER_UPDATED'),
