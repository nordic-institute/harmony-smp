...
class ApplicationResourceIT {
    ...
    void testGetApplicationConfigUser() throws Exception {
        ...
        assertNotNull(res);
        assertEquals(SMPPropertyEnum.RESOURCE_SCH_REGEXP_MSG.getDefValue(), res.getParticipantSchemaRegExpMessage());
        assertEquals(SMPPropertyEnum.RESOURCE_SCH_VALIDATION_REGEXP.getDefValue(), res.getParticipantSchemaRegExp());
