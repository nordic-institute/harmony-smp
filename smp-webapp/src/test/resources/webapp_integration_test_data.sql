-- because  h2 "ID bigint generated by default as identity", is not detecting used ids (throws primary key vialation )
-- use negative values for preset ids
...
(-2, 1, -2, 1, 'ehealth-actorid-qns', 'urn:brazil:ncpb', 0, 'PUBLIC', NOW(),  NOW());
