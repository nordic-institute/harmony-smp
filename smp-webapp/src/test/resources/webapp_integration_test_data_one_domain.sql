...
insert into SMP_CONFIGURATION (PROPERTY_NAME, PROPERTY_VALUE, CREATED_ON, LAST_UPDATED_ON) VALUES ('smp.keystore.filename', 'smp-keystore.p12',CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
