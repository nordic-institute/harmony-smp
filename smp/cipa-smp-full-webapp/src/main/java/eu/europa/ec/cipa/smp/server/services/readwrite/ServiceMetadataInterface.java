...
import eu.europa.ec.smp.api.ServiceMetadataValidator;
...
public final class ServiceMetadataInterface {
  ...
  public Response saveServiceRegistration (@PathParam ("ServiceGroupId") final String sServiceGroupID,
    ...
    ServiceMetadataValidator serviceMetadataValidator = new ServiceMetadataValidator();
    serviceMetadataValidator.validateXSD(body);
