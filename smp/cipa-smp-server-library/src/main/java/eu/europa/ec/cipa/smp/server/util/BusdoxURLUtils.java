...
public final class BusdoxURLUtils {
   ...
   */
  @Nonnull
  public static String getDNSNameOfParticipant (@Nonnull final ParticipantIdentifierType aParticipantIdentifier,
    ...
    if ("*".equals (sValue)) {
      ...
      ret.append (DNS_HASHED_IDENTIFIER_PREFIX)
  ...
  @Nonnull
  public static URI getSMPURIOfParticipant (@Nonnull final ParticipantIdentifierType aParticipantIdentifier,
  ...
  @Nonnull
  public static URL getSMPURLOfParticipant (@Nonnull final ParticipantIdentifierType aParticipantIdentifier,
                                            @Nonnull final ISMLInfo aSMLInfo) {
    ValueEnforcer.notNull (aParticipantIdentifier, "ParticipantIdentifier");
    ValueEnforcer.notNull (aSMLInfo, "SMLInfo");
