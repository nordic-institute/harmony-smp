...
public final class IdentifierUtils {
  ...
  public static boolean isValidDocumentTypeIdentifier (@Nullable final String sValue) {
    if (sValue == null)
      return false;
    final DocumentIdentifier aID = createDocumentTypeIdentifierFromURIPartOrNull (sValue);
    return aID != null &&
  ...
  public static boolean isValidParticipantIdentifier (@Nullable final String sValue) {
    if (sValue == null)
      return false;
    final ParticipantIdentifierType aID = createParticipantIdentifierFromURIPartOrNull (sValue);
    return aID != null &&
  ...
  public static boolean isValidProcessIdentifier (@Nullable final String sValue) {
    if (sValue == null)
      return false;
    final ProcessIdentifier aID = createProcessIdentifierFromURIPartOrNull (sValue);
   ...
   *         <code>false</code> otherwise
   */
  public static boolean hasDefaultParticipantIdentifierScheme (@Nonnull final ParticipantIdentifierType aIdentifier) {
   ...
   *         <code>false</code> otherwise
   */
  public static boolean hasDefaultDocumentTypeIdentifierScheme (@Nonnull final DocumentIdentifier aIdentifier) {
   ...
   *         <code>false</code> otherwise
   */
  public static boolean hasDefaultProcessIdentifierScheme (@Nonnull final ProcessIdentifier aIdentifier) {
   ...
   */
  @Nullable
  public static DocumentIdentifier createDocumentTypeIdentifierFromURIPartOrNull (@Nonnull final String sURIPart) {
    ...
    if (aSplitted.size () == 2) {
      ...
      if (isValidIdentifierScheme (sScheme)) {
        ...
        if (isValidDocumentTypeIdentifierValue (sValue)) {
          ...
          id.setScheme(aSplitted.get(0));
          id.setValue(aSplitted.get(1));
          return id;
        }
      }
    }
   ...
   */
  @Nonnull
  public static DocumentIdentifier createDocumentTypeIdentifierFromURIPart (@Nonnull final String sURIPart) {
    final DocumentIdentifier ret = createDocumentTypeIdentifierFromURIPartOrNull (sURIPart);
    if (ret == null)
   ...
   */
  @Nullable
  public static ParticipantIdentifierType createParticipantIdentifierFromURIPartOrNull (@Nonnull final String sURIPart) {
    ValueEnforcer.notNull (sURIPart, "URIPart");
   ...
   */
  @Nonnull
  public static ParticipantIdentifierType createParticipantIdentifierFromURIPart (@Nonnull final String sURIPart) {
    final ParticipantIdentifierType ret = createParticipantIdentifierFromURIPartOrNull (sURIPart);
    if (ret == null)
   ...
   */
  @Nullable
  public static ProcessIdentifier createProcessIdentifierFromURIPartOrNull (@Nonnull final String sURIPart) {
    ValueEnforcer.notNull (sURIPart, "URIPart");
   ...
   */
  @Nonnull
  public static ProcessIdentifier createProcessIdentifierFromURIPart (@Nonnull final String sURIPart) {
    final ProcessIdentifier ret = createProcessIdentifierFromURIPartOrNull (sURIPart);
    if (ret == null)
   ...
   */
  @Nullable
  public static String getIssuingAgencyIDFromParticipantIDValue (@Nonnull final ParticipantIdentifierType aIdentifier) {
    ValueEnforcer.notNull (aIdentifier, "Identifier");
   ...
   */
  @Nullable
  public static String getLocalParticipantIDFromParticipantIDValue (@Nonnull final ParticipantIdentifierType aIdentifier) {
    ValueEnforcer.notNull (aIdentifier, "Identifier");
